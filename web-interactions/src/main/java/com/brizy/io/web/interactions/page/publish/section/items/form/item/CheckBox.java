...
public class CheckBox implements FormItem {
    ...
    public CheckBox(FormCheckBoxItemLocators checkBoxLocators, Locator elementLocator) {
        this.type = "checkbox";
        this.placeHolder = elementLocator.getAttribute("data-brz-placeholder");
        this.items = () -> elementLocator.locator(checkBoxLocators.getItems()).all()
                .stream()
