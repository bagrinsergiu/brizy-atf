package com.brizy.io.web.interactions.properties.editor.workspace.section.container.item.toolbar.button.tabs.icon.icon.picker.pop_up;
...
@NoArgsConstructor
public class IconPickerPopupLocators extends AbstractProperty {
