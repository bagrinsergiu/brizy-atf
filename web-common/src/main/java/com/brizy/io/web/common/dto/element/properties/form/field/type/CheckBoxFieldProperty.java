...
public class CheckBoxFieldProperty extends AbstractFieldProperty {

    FieldWithOptionsAndColumnsConfigurationProperty configuration;

    public CheckBoxFieldProperty(Integer spacing, String type, String placeholder, boolean required, FieldWithOptionsAndColumnsConfigurationProperty configuration) {
