@Smoke
Feature: Editor Page - Lottie element Toolbar
  As a user
  I want to customize a Lottie element
  ...
  Scenario Outline: Add lottie element and validate toolbar items
    When prepare the following items to be added to the page:
      | item   | position | parent | name   | sectionName   |
      | LOTTIE | -        | -      | <name> | <sectionName> |
