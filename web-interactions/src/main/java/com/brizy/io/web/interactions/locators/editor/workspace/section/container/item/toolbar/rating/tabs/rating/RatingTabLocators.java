package com.brizy.io.web.interactions.locators.editor.workspace.section.container.item.toolbar.rating.tabs.rating;
...
@NoArgsConstructor
public class RatingTabLocators extends AbstractTabLocators {
    ...
    @NestedConfigurationProperty
    InputWithPopulationLocators rating;
