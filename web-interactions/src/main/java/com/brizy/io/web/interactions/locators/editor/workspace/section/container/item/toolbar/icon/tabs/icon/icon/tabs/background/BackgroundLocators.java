package com.brizy.io.web.interactions.locators.editor.workspace.section.container.item.toolbar.icon.tabs.icon.icon.tabs.background;
...
@NoArgsConstructor
public class BackgroundLocators extends AbstractProperty {
