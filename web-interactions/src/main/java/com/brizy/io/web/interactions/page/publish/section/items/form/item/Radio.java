...
public class Radio implements FormItem {
    ...
    public Radio(FormRadioItemLocators radioLocator, Locator elementLocator) {
        this.type = "radio";
        this.placeHolder = elementLocator.getAttribute("data-brz-placeholder");
        this.items = () -> elementLocator.locator(radioLocator.getItems()).all()
                .stream()
